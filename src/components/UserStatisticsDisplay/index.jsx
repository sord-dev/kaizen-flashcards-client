    ...
    return (
        <div className={styles['stats-display']} style={{backgroundColor: `${theme.primBG}`, color: `${theme.primText}`}}>
            ...
            <div className={styles['stats-grid']}>
                ...
                <UserStatGridItem tag={'Correct Percentage'} description={'Percentage for answers to all cards.'} number= {!userStats.amount == 0 ? (userStats.correct/userStats.amount) *100 + "%" : 0} />
            </div>
        </div>
    )
}
